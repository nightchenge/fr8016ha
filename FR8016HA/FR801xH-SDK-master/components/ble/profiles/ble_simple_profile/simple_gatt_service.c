...
{
	[SP_IDX_SERVICE]={ { UUID_SIZE_2, UUID16_ARR(GATT_PRIMARY_SERVICE_UUID) },     								/* UUID */
                                                    GATT_PROP_READ,                                             /* Permissions */
                                                    UUID_SIZE_2,                                                /* Max size of the value */     /* Service UUID size in service declaration */
                                                    (uint8_t*)sp_svc_uuid,                                      /* Value of the attribute */   
                     },
		
	[SP_IDX_CHAR1_DECLARATION]={{ UUID_SIZE_2, UUID16_ARR(GATT_CHARACTER_UUID) },           					/* UUID */
                                                    GATT_PROP_READ,                                             /* Permissions */
                                                    0,                                                          /* Max size of the value */
                                                    NULL,                                                       /* Value of the attribute */
							   },
	[SP_IDX_CHAR1_VALUE]={{ UUID_SIZE_16, SP_CHAR1_TX_UUID },                 									/* UUID */
                                                    GATT_PROP_READ | GATT_PROP_NOTI|GATT_PROP_WRITE,            /* Permissions */
                                                    SP_CHAR1_VALUE_LEN,                                         /* Max size of the value */
                                                    NULL,                                                       /* Value of the attribute */ 
                         },
	[SP_IDX_CHAR1_CFG]={ { UUID_SIZE_2, UUID16_ARR(GATT_CLIENT_CHAR_CFG_UUID) },     							/* UUID */
                                                    GATT_PROP_READ | GATT_PROP_WRITE,                           /* Permissions */
                                                    2,                                           				/* Max size of the value */
                                                    NULL,                                                       /* Value of the attribute */
						},
    [SP_IDX_CHAR1_USER_DESCRIPTION]={ { UUID_SIZE_2, UUID16_ARR(GATT_CHAR_USER_DESC_UUID) },      				/* UUID */
                                                    GATT_PROP_READ,                                             /* Permissions */
...
const gatt_attribute_t simple_profile_att_table[SP_IDX_NB] =
{
    ...
    [SP_IDX_SERVICE]                        =   {
        ...
        [SP_IDX_CHAR1_VALUE]                =   {
                                                    { UUID_SIZE_2, UUID16_ARR(SP_CHAR1_TX_UUID) },                 /* UUID */
        ...
        [SP_IDX_CHAR2_VALUE]                =   {
                                                    { UUID_SIZE_2, UUID16_ARR(SP_CHAR2_RX_UUID) },                 /* UUID */
                                                    GATT_PROP_READ | GATT_PROP_WRITE,                                             /* Permissions */
...
static uint16_t sp_gatt_msg_handler(gatt_msg_t *p_msg)
{
	printf("lootom log:p_msg->msg_evt:%d.\n",p_msg->msg_evt);
	switch(p_msg->msg_evt)
	{
		case GATTC_MSG_READ_REQ:
		{
