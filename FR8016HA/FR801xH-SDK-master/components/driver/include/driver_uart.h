...
3       EMSI     W/R        鈥?鈥? Enable Modem Status Interrupt (EMSI)
                                    鈥?鈥? Disable EMSI
2       ERLSI   W/R         鈥?鈥? Enable Receive Line Status Interrupt (ERLSI)
                                    鈥?鈥? Disable ERLSI
1       ETI      W/R          鈥?鈥? Enable THR Empty Interrupt (ETI)
                                    鈥?鈥? Disable ETI
0       ERDI    W/R          鈥?鈥? Enable Received Data Available Interrupt (ERDI)
                                    鈥?鈥? Disable ERDI
*/
...
5:4     Tx Trigger WO       Indicate the trigger level for the transmit FIFO interrupt.
                                        ...
                                        10 --- FIFO 1/4 full
                                        11 --- FIFO 1/2 full
3       DMA          WO         鈥?鈥?TXRDYN,RXRDYN signal work in DMA mode 0
        Mode                        鈥?鈥?TXRDYN,RXRDYN signal work in DMA mode 1
...
3       OUT2        W/R       User Designated Output
                                        鈥?鈥? set OUT2n to 鈥?鈥? active
                                        鈥?鈥? set OUT2n to 鈥?鈥? normal
2       OUT1        W/R       User Designated Output
                                        鈥?鈥? set OUT1n to 鈥?鈥? active
                                        鈥?鈥? set OUT1n to 鈥?鈥? normal
1       RTS          W/R        Request to Send
                                        鈥?鈥? set RTSn to 鈥?鈥? active
                                        鈥?鈥? set RTSn to 鈥?鈥? normal
0       DTR         W/R         Data Terminal Ready
                                        鈥?鈥? set DTRn to 鈥?鈥? active
                                        鈥?鈥? set DTRn to 鈥?鈥? normal
*/
