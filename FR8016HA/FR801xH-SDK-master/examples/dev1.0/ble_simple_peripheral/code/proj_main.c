...
{
    co_printf("\r\nuser_entry_before_sleep_imp strat\r\n");
    ...
    pmu_set_pin_dir(GPIO_PORT_A, BIT(4), GPIO_DIR_OUT);
    pmu_set_pin_pull(GPIO_PORT_A, BIT(4), true);
    pmu_set_gpio_value(GPIO_PORT_A, BIT(0), 1);

    pmu_set_pin_to_PMU(GPIO_PORT_A, (1 << GPIO_BIT_0)); // lte reset
    pmu_set_port_mux(GPIO_PORT_A, GPIO_BIT_0, PMU_PORT_MUX_GPIO);
    pmu_set_pin_dir(GPIO_PORT_A, BIT(0), GPIO_DIR_OUT);
    pmu_set_pin_pull(GPIO_PORT_A, BIT(0), true);
    pmu_set_gpio_value(GPIO_PORT_A, BIT(0), 0);

    pmu_set_pin_to_PMU(GPIO_PORT_A, (1 << GPIO_BIT_7)); // lte power
    pmu_set_pin_dir(GPIO_PORT_A, BIT(7), GPIO_DIR_OUT);
    pmu_set_pin_pull(GPIO_PORT_A, BIT(7), true);
    pmu_set_gpio_value(GPIO_PORT_A, BIT(7), 1);

    pmu_set_pin_to_PMU(GPIO_PORT_A, (1 << GPIO_BIT_5)); // DTR
    pmu_set_pin_dir(GPIO_PORT_A, BIT(5), GPIO_DIR_OUT);
    pmu_set_pin_pull(GPIO_PORT_A, BIT(5), true);
    pmu_set_gpio_value(GPIO_PORT_A, BIT(5), 1);

    pmu_set_pin_to_PMU(GPIO_PORT_A, (1 << GPIO_BIT_6)); // wakeup with EC800G
    pmu_set_pin_pull(GPIO_PORT_A, BIT(6), true);

    pmu_set_pin_to_PMU(GPIO_PORT_A, (1 << GPIO_BIT_1)); // wakeup button
    pmu_set_pin_pull(GPIO_PORT_A, BIT(1), true);

    pmu_port_wakeup_func_set(GPIO_PA1 | GPIO_PA6);
    NVIC_EnableIRQ(PMU_IRQn);
    //   g_wakeup_reason = 'U';
